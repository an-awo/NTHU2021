...
- MUL instruction  請參閱教科書說明
  ...
  - MUL accepts a single operand,the multiplier
  - 範例 :mul bx
  - but what about the multiplicand and the result? 
  - The multiplicand is a value that is stored in the accumulator register based on the multiplier size (8, 16, 32, and 64-bit), see Table 4.2 Unsigned multiplication operands
```
mov ax, 64 
mov bx, 8096 
mul bx
...
### [完成課本範例程式Program_5.1 Conditional jump (32-bit)的測試](https://github.com/brianrhall/Assembly/tree/master/Chapter_4/Program%20)
